...
void loadGeometry2() {
  ...
  globalColorID = glGetUniformLocation(test_shader_program, "globalColor");
  MatrixID = glGetUniformLocation(test_shader_program, "MVP");

  globalColor = glm::vec4(0.5, 0.5, 0.5, 1.0);
...
void doThings2() {
  ...
  glUniform4fv(globalColorID, 1, glm::value_ptr(globalColor));
